<template>
  ...
  <div>
    ...
    <div v-if="showHupan4Image" class="image-container">
      <img src="/7dong.png" alt="二期7栋的图片" class="center-top">
    ...
    <div v-if="showHupan5Image" class="image-container">
      <img src="/8dong.png" alt="二期8栋的图片" class="center-top">
      <div class="button-container">
        <el-button type="primary" plain @click="goBack">返回</el-button>
      </div>
    </div>
    ...
    <div v-if="showHupan6Image" class="image-container">
      <img src="/9栋.png" alt="二期9栋的图片" class="center-top">
      <div class="button-container">
        <el-button type="primary" plain @click="goBack">返回</el-button>
      </div>
    </div>
    <div class="line"></div>
    <div v-if="showHupan7Image" class="image-container">
      <img src="/10栋.png" alt="二期10栋的图片" class="center-top">
      <div class="button-container">
        <el-button type="primary" plain @click="goBack">返回</el-button>
      </div>
    </div>
    <div class="line"></div>
    <div v-if="showHupan8Image" class="image-container">
      <img src="/17栋.png" alt="二期17栋的图片" class="center-top">
      <div class="button-container">
        <el-button type="primary" plain @click="goBack">返回</el-button>
      </div>
    </div>
...
<script>
import pictur1 from  '@/picture/二期单人1.jpg'
import pictur2 from   '@/picture/二期单人2.jpg'
import pictur3 from  '@/picture/二期双人矮1.jpg'
import pictur4 from  '@/picture/二期双人矮2.png'
import pictur5 from  '@/picture/二期双人高1.png'
import pictur6 from  '@/picture/二期双人高2.png'
...
export default {
  ...
  data() {
    return {
      ...
      showHupan7Image: false,
      showHupan8Image: false,
  ...
  created() {
    ...
    this.$axios.get(this.$httpUrl+'/distributionGrade/二期',{
      withCredentials: true,
      headers:{
        'Authorization':"Bearer"+" "+JSON.parse(sessionStorage.getItem('CurUser')).token
      },
  ...
  methods: {
    ...
    initPanorama(width, height) {
      ...
      infospot5.position.set( -1475, -3611, -3118 );
      infospot5.addHoverText( '二期10栋' );
      infospot5.addEventListener('click', () => {
        // 点击湖畔4栋时切换到图片模式
        this.showHupan7Image = true;
        this.tupian = true;
        this.quanju=false;
      ...
      infospot6.position.set( -2475, -2611, -3118 );
      infospot6.addHoverText( '二期7栋' );
      ...
      infospot7.position.set( -2475, -2611, -4000 );
      infospot7.addHoverText( '二期8栋' );
      ...
      infospot8.position.set( -2075, -3111, -3118 );
      infospot8.addHoverText( '二期9栋' );
      ...
      infospot9.position.set( 1000, -3111, 300 );
      infospot9.addHoverText( '二期17栋' );
      infospot9.addEventListener('click', () => {
        // 点击湖畔4栋时切换到图片模式
        this.showHupan8Image = true;
        this.tupian = true;
        this.quanju=false;
      ...
      this.panorama.add(infospot8);
      this.panorama.add(infospot9);
      ...
      this.panorama.position.set(-1475, -3611, -3118);
    },
    goBack() {
      // 返回到全景容器
      this.quanju=true;
      ...
      this.showHupan7Image = false;
      this.showHupan8Image = false;
      this.tupian = false;
      // 重新初始化全景容器
