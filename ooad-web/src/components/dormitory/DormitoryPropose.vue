...
<template>
    <div>
        ...
        <div>
            <div v-if="active === 0">
                <div style="display: flex; flex-direction: column; justify-content:center; align-items: flex-start; height: 500px; margin-left: 400px; font-family: arial, sans-serif;font-size: 15px">
