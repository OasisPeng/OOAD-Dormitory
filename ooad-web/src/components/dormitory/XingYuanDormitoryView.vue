  ...
  <!--  D:\OneDrive - 南方科技大学\课程\创新实践-->
    <div>
        ...
        <div v-if="showHupan4Image" class="image-container">
            <img src="/欣园3.png" alt="欣园3栋的图片" class="center-top">
        ...
        <div v-if="showHupan5Image" class="image-container">
            <img src="/欣园5.png" alt="欣园5栋的图片" class="center-top">
            <div class="button-container">
                <el-button type="primary" plain @click="goBack">返回</el-button>
            </div>
        </div>
...
<script>
import pictur1 from  '@/picture/欣园双人1.jpg'
import pictur2 from   '@/picture/欣园双人2.jpg'
import pictur3 from  '@/picture/欣园三人1.jpg'
import pictur4 from  '@/picture/欣园三人2.jpg'
import pictur5 from  '@/picture/欣园四人1.jpg'
import pictur6 from  '@/picture/欣园四人2.jpg'
...
export default {
    ...
    created() {
        ...
        this.$axios.get(this.$httpUrl+'/distributionGrade/欣园',{
    ...
    methods: {
        ...
        initPanorama(width, height) {
            ...
            infospot5.position.set( -1252, -3103, 3730 );
            infospot5.addHoverText( '欣园3栋' );
            ...
            infospot6.position.set( -1252, -2303, 3730 );
            infospot6.addHoverText( '欣园5栋' );
            ...
            this.panorama = new PANOLENS.ImagePanorama('/huiyuan.jpg');
            ...
            this.panorama.position.set(-1252, -3103, 3730);
        },
        goBack() {
            // 返回到全景容器
            this.quanju=true;
