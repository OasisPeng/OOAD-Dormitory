...
public class JwtUtils {
    ...
    public DecodedJWT resolveJwt(String headerToken) {
        ...
        try {
            ...
            if (this.isInvalidation(verify.getId())) {
                return null;
            }
            Date ex = verify.getExpiresAt();
            return new Date().after(ex) ? null:verify;
    ...
    private boolean isInvalidation(String id) {
